...
export const GET_INSTITUE_CALENDAR_DATA_IP = BACKEND_API + '/institude-calendar/get';
export const UPDATE_INSTITUE_CALENDAR_DATA_IP = BACKEND_API + '/institude-calendar/post';